                ...
                <tbody>
                  <?php foreach ($reports as $key => $report): ?>
                    <tr class="odd gradeX">
                      ...
                      <td><a href="{{  url('admin/company_report/edit/'.$report->id) }}">Edit</a>&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are you sure you want to delete it?');" href="{{  url('admin/reports/delete/'.$report->id) }}">Delete</a></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
